                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1">Rp.<span data-plugin="counterup">111</span>
                                        </h3>
                                        <p class="text-muted mb-1 text-truncate">Total Dibayarkan</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">111</span>
                                        </h3>
                                        <p class="text-muted mb-1 text-truncate">Total Jatuh Tempo</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
